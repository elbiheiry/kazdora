                            ...
                            <form class="login-form" method="post" action="{{route('password.update')}}">
                                ...
                                <div class="form-cont">
                                    <div class="form-group">
                                        ...
                                        @error('email')
                                            <span><i class="error-data" style="text-align:center; color: #D10508; font-size: 14px;">{{$message}}</i></span>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <button class="custom-btn" type="submit"> Reset your password</button>
                                    </div>
                                </div>
                            </form>
